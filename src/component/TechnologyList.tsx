...
handleAddToChart={handleAddToChart}
 isAdded={stack.some(item => item.id === technology.id)}
        ...
        <div className="max-h-max w-full lg:w-100  max-w-sm  rounded-xl p-4  shadow-md items-center gap-5 ">
        ...
        className=" font-semibold hover:text-red-700 border-2 border-red-400  mt-10 ml-20 px-3 rounded-2xl  bg-gradient-to-r from-orange-500 via-pink-500 to-violet-500 text-white"
            > Remove All</button>)}
